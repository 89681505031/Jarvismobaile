    ...
    fun checkAutomaticallyOnLaunch() {
        ...
        io.execute {
            ...
            try {
                ...
                val wanted = if (context.packageName.endsWith(".tray2"))
                    "Jarvis-Mobile-TRAY2-signed.apk"
                else if (context.packageName.endsWith(".brain"))
    ...
    fun check() {
        ...
        io.execute {
            try {
                ...
                val expectedName = if (context.packageName.endsWith(".tray2"))
                    "Jarvis-Mobile-TRAY2-signed.apk"
                else if (context.packageName.endsWith(".brain"))
                    "Jarvis-Mobile-BRAIN-signed.apk"
                else if (context.packageName.endsWith(".hud3"))
